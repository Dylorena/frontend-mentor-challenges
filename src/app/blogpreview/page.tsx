...
export default function BlogPreview() {
  return (
    ...
    >
      <main className="bg-white w-[20.4375rem] h-[31.3125rem] p-6 rounded-[20px] ring-1 ring-inset flex flex-col gap-6 lg:w-[24rem] lg:h-[32.625rem] shadow-[8px_8px_0_#000]">
        <Image
        ...
        <section className="flex flex-col gap-y-3">
          <Typografy
            as="p"
            variant="preset-3-b"
            className="bg-yellow mb-3 w-[4.5625rem] h-[1.625rem] rounded-sm text-center content-center"
          >
            Learning
          </Typografy>
